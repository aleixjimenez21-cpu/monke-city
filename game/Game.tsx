...
export default function Game(){
 ...
 return <main className={`game phase-${view.phase} scene-${view.scene}`}><canvas ref={canvas} aria-label="Monke City. Move with A and D, jump with Space, interact with E. Start with seven dollars, learn about Monke City, get a city ticket and reach the overlook."/><div className="film-grain"/>
